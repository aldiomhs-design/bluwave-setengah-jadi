...
<head>
  ...
  <title>BlueWaves STORE — PUBG Mobile</title>
...
<body>
  ...
  <main>
    <form action="" method="post" id="orderForm" enctype="multipart/form-data">
      <!-- USER ID -->
      <input type="hidden" value="PUBG Mobile" name="game">
      <div class="card">
        <h3>Masukkan User ID PUBG Anda</h3>
  ...
  <script>
    ...
    const sample = [
      ...
      [300, '300 + 25 UC', 74999],
      [325, '325 + 60 UC', 89999],
      [600, '600 + 60 UC', 149999],
      [720, '720 + 60 UC', 179999],
      [1500, '1500 + 300 UC', 425098]
    ];
