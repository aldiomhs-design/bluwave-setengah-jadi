...
if (isset($_POST["pesan"])) {
  ...
  if (empty($game) || empty($userId) || empty($serverId)) {
    ...
    if ($buktiPembayaran) {
      $query = "INSERT INTO topup (game, user_id, id_akun, server_id, produk, harga, pembayaran, status , tanggal) VALUES ('$game','$userId','$idAkun','$serverId','$namaProduk','$hargaProduk','$metode','$buktiPembayaran')";
    } else {
